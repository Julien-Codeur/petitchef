...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .stat-card { background-color: white; border-radius: 8px; padding: 20px; border: 1px solid #e0e0e0; text-align: center; }
        .stat-number { font-size: 32px; font-weight: 700; color: #ff6b35; font-family: 'Plus Jakarta Sans', sans-serif; }
        .stat-label { font-size: 13px; color: #666; margin-top: 8px; font-weight: 500; }
    </style>
</head>
<body>
    ...
    <div class="main-content">
        ...
        <div class="header">
            <div class="header-left">
                <span>mercredi, 8 avril 2026</span>
                <span>15:47</span>
            </div>
